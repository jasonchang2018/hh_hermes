...
(
    ...
    from        with_flags
    where       case    when    proposed_channel = 'Letter'         then (is_eligible_cost_letters  and is_eligible_margin_letters)
                        when    proposed_channel = 'Text Message'   then (is_eligible_cost_texts    and is_eligible_margin_texts)
                        when    proposed_channel = 'VoApp'          then (is_eligible_cost_voapps   and is_eligible_margin_voapps)
                        when    proposed_channel = 'Email'          then (is_eligible_cost_emails   and is_eligible_margin_emails)
                        end
)
