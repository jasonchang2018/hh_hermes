create or replace table
    edwprodhh.hermes.report_eval_model_v1_texts
as
...
(
    select      tax_season.contact_id,
                ...
                texts_base.dol_commission_attr      as fee_actual,
                tax_season.score_value              as score_tax,
                hermes_v1.PREDICTED_VALUES          as score_hermesv1
    ...
    from        edwprodhh.pub_jchang.report_tax_hermes_comparison_scored as tax_season
                ...
                inner join
                    edwprodhh.jchang_tax_season_2023.temp_project_taxseason2023_training_texts_base as texts_base
                    on tax_season.contact_id = texts_base.contact_id
                inner join
                    (select distinct * from edwprodhh.pub_mbutler.texts_reserves_predicted) as hermes_v1
                    on tax_season.contact_id = hermes_v1.contact_id

    where       tax_season.contact_type = 'Text Message'
)
, external_scores as
(
    with filtered as
