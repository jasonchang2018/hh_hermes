...
(
    ...
    (
        select      pool.pl_group,
                    ...
                    sum(pool.pass_validation_requirement_offer)                                 ::number(18,0)  as pass_validation_requirement_offer,
                    sum(pool.pass_validation_requirement_nonoffer)                              ::number(18,0)  as pass_validation_requirement_nonoffer,
    ...
    (
        ...
        (
            select      pl_group,
                        ...
                        pass_validation_requirement_offer as pass_validation_requirement,
    ...
    (
        ...
        (
            select      pl_group,
                        ...
                        pass_debtor_status,
                        pass_phone_voapps,
                        pass_validation_requirement_nonoffer as pass_validation_requirement,
                        pass_debtor_balance,
...
(
    ...
    (
        select      pool.debtor_idx,
                    ...
                    case    when    letters_pass_address_letters_           = 1 then    pool.pass_validation_requirement_offer                                  else 0 end  as letters_pass_validation_requirement_,
                    ...
                    case    when    voapps_pass_phone_voapps_               = 1 then    pool.pass_validation_requirement_nonoffer                               else 0 end  as voapps_pass_validation_requirement_,
                    ...
                    case    when    texts_pass_phone_texts_                 = 1 then    pool.pass_validation_requirement_nonoffer                               else 0 end  as texts_pass_validation_requirement_,
