...
select      distinct
            ...
            case    when    pl_group = 'ADVOCATE HC - 3P'                                       then    0
                    ...
                    when    pl_group = 'CARLE HEALTHCARE - 3P'	                                then    220
                    ...
                    when    pl_group = 'CITY OF LA CA - PARKING CONDUENT - 3P'	                then    110
                    ...
                    when    pl_group = 'CITY OF PHILADELPHIA PA - PARKING - 3P'	                then    330
                    ...
                    when    pl_group = 'MCLEOD HEALTH - 3P'	                                    then    220
                    when    pl_group = 'MOUNT SINAI - 3P'	                                    then    110
                    when    pl_group = 'NORTHSHORE UNIV HEALTH - 3P'	                        then    440
                    ...
                    when    pl_group = 'STATE OF KS - DOR - 3P'	                                then    1060
                    when    pl_group = 'STATE OF LA - DOR - 3P'	                                then    0
                    when    pl_group = 'STATE OF MD - DBM CCU - 3P'	                            then    0
                    when    pl_group = 'STATE OF OK - TAX COMMISSION - 3P'	                    then    880
                    ...
                    when    pl_group = 'U OF CHICAGO MEDICAL - 3P'	                            then    220
            ...
            case    when    pl_group = 'ADVOCATE HC - 3P'                                       then  0
                    when    pl_group = 'ASPEN DENTAL - 3P'                                      then  110
                    ...
                    when    pl_group = 'BROWARD HEALTH - 3P'                                    then  110
                    ...
                    when    pl_group = 'PRISMA HEALTH UNIVERSITY - 3P'                          then  440
                    when    pl_group = 'PROMEDICA HS - 3P-2'                                    then  660
                    when    pl_group = 'PROVIDENCE ST JOSEPH HEALTH - 3P'                       then  2200
                    when    pl_group = 'SHIRLEY RYAN ABILITY LABS - 3P'                         then  0
                    when    pl_group = 'SILVER CROSS - 3P'                                      then  0
                    when    pl_group = 'SILVER CROSS - HEALTH SYSTEM SERVICES INC - 3P'         then  0
                    when    pl_group = 'ST ELIZABETH HEALTHCARE - 3P'                           then  110
                    when    pl_group = 'STATE OF IL - DOR - 3P'                                 then  220
                    when    pl_group = 'STATE OF IL - DOR - 3P-2'                               then  0
                    ...
                    when    pl_group = 'TOWER HEALTH HOSP - 3P -2'                              then  0
                    when    pl_group = 'TOWER HEALTH PHYS - 3P -2'                              then  0
                    when    pl_group = 'TPC - SHANNON - HOSP - 3P-2'                            then  110
                    when    pl_group = 'TPC - SHANNON - PHY - 3P-2'                             then  550
                    when    pl_group = 'TPC - UNITED REGIONAL - 3P'                             then  0
                    when    pl_group = 'U OF CHICAGO MEDICAL - 3P'                              then  330
                    when    pl_group = 'U OF CINCINNATI HEALTH SYSTEM - 3P'                     then  110
                    when    pl_group = 'U OF IL AT CHICAGO - 3P'                                then  110
                    when    pl_group = 'UNITED REGIONAL - 3P-2'                                 then  0
