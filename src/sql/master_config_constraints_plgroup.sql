...
select      distinct
            ...
            case    when    pl_group = 'ADVOCATE HC - 3P'                                       then    0
                    ...
                    when    pl_group = 'BAYLOR SCOTT WHITE HEALTHCARE EPIC - 3P'	            then    500
                    when    pl_group = 'BAYLOR SCOTT WHITE HEALTHCARE EPIC - 3P-2'	            then    500
                    when    pl_group = 'BROWARD HEALTH - 3P'	                                then    0
                    when    pl_group = 'CARLE HEALTHCARE - 3P'	                                then    200
                    when    pl_group = 'CARLE HEALTHCARE - 3P-2'	                            then    100
                    when    pl_group = 'CHILDRENS HOSP OF ATLANTA - 3P'	                        then    200
                    ...
                    when    pl_group = 'CITY OF LA CA - PARKING CONDUENT - 3P'	                then    100
                    ...
                    when    pl_group = 'CITY OF PHILADELPHIA PA - PARKING - 3P'	                then    300
                    when    pl_group = 'CITY OF SAN FRANCISCO CA - MTA - 3P'	                then    0
                    when    pl_group = 'CITY OF SEATTLE WA - MUNI COURT - 3P'	                then    200
                    ...
                    when    pl_group = 'ELIZABETH RIVER CROSSINGS - 3P'	                        then    1760
                    ...
                    when    pl_group = 'LOYOLA UNIV HEALTH SYSTEM - 3P'	                        then    200
                    when    pl_group = 'MCLEOD HEALTH - 3P'	                                    then    200
                    when    pl_group = 'MOUNT SINAI - 3P'	                                    then    100
                    when    pl_group = 'NORTHSHORE UNIV HEALTH - 3P'	                        then    400
                    when    pl_group = 'NORTHWESTERN MEDICINE - 3P'	                            then    300
                    when    pl_group = 'NW COMM HOSP - 3P'	                                    then    100
                    when    pl_group = 'NW COMM HOSP - 3P-2'	                                then    0
                    when    pl_group = 'PALOS HEALTH - 3P'	                                    then    0
                    when    pl_group = 'PRISMA HEALTH - 3P'	                                    then    800
                    when    pl_group = 'PRISMA HEALTH - 3P-2'	                                then    800
                    when    pl_group = 'PRISMA HEALTH UNIVERSITY - 3P'	                        then    0
                    when    pl_group = 'PROMEDICA HS - 3P-2'	                                then    0
                    when    pl_group = 'PROVIDENCE ST JOSEPH HEALTH - 3P'	                    then    500
                    ...
                    when    pl_group = 'STATE OF IL - DOR - 3P'	                                then    200
                    when    pl_group = 'STATE OF IL - DOR - 3P-2'	                            then    0
                    when    pl_group = 'STATE OF KS - DOR - 3P'	                                then    960
                    when    pl_group = 'STATE OF LA - DOR - 3P'	                                then    0
                    when    pl_group = 'STATE OF MD - DBM CCU - 3P'	                            then    0
                    when    pl_group = 'STATE OF OK - TAX COMMISSION - 3P'	                    then    800
                    when    pl_group = 'STATE OF PA - TURNPIKE COMMISSION - 3P'	                then    880
                    when    pl_group = 'STATE OF UT - OSDC - 3P'	                            then    0
                    when    pl_group = 'STATE OF UT - OSDC - 3P-2'	                            then    0
                    when    pl_group = 'STATE OF VA - DOT - 3P'	                                then    200
                    when    pl_group = 'STATE OF VA - DOT - 3P-2'	                            then    1600
                    ...
                    when    pl_group = 'U OF CHICAGO MEDICAL - 3P'	                            then    200
                    when    pl_group = 'U OF CINCINNATI HEALTH SYSTEM - 3P'	                    then    0
                    when    pl_group = 'U OF IL AT CHICAGO - 3P'	                            then    100
                    when    pl_group = 'UNITED REGIONAL - 3P-2'	                                then    0
                    when    pl_group = 'UNIVERSAL HEALTH SERVICES - 3P'	                        then    1200
                    when    pl_group = 'WEILL CORNELL PHY - 3P'	                                then    0
                    else    0
                    end     as  max_cost_running_client,
            case    when    pl_group = 'ADVOCATE HC - 3P'                                       then    0
                    when    pl_group = 'ASPEN DENTAL - 3P'	                                    then    0
                    when    pl_group = 'BAYLOR SCOTT WHITE HEALTHCARE EPIC - 3P'	            then    100
                    when    pl_group = 'BAYLOR SCOTT WHITE HEALTHCARE EPIC - 3P-2'	            then    100
                    when    pl_group = 'BROWARD HEALTH - 3P'	                                then    0
                    ...
                    when    pl_group = 'ELIZABETH RIVER CROSSINGS - 3P'	                        then    2000
                    when    pl_group = 'EVERGY - 3P'	                                        then    0
                    when    pl_group = 'EVERGY - 3P-2'	                                        then    0
                    when    pl_group = 'EVERSOURCE ENERGY - 3P'	                                then    0
                    ...
                    when    pl_group = 'LURIE CHILDRENS - 1P'	                                then    300
                    ...
                    when    pl_group = 'NORTHSHORE UNIV HEALTH - 3P'	                        then    100
                    when    pl_group = 'NORTHWESTERN MEDICINE - 3P'	                            then    200
                    ...
                    when    pl_group = 'PRISMA HEALTH UNIVERSITY - 3P'	                        then    0
                    when    pl_group = 'PROMEDICA HS - 3P-2'	                                then    100
                    when    pl_group = 'PROVIDENCE ST JOSEPH HEALTH - 3P'	                    then    300
                    when    pl_group = 'SHIRLEY RYAN ABILITY LABS - 3P'	                        then    0
                    when    pl_group = 'SILVER CROSS - 3P'	                                    then    0
                    ...
                    when    pl_group = 'STATE OF MD - DBM CCU - 3P'	                            then    0
                    when    pl_group = 'STATE OF OK - TAX COMMISSION - 3P'	                    then    400
                    when    pl_group = 'STATE OF PA - TURNPIKE COMMISSION - 3P'	                then    1400
                    when    pl_group = 'STATE OF UT - OSDC - 3P'	                            then    0
                    when    pl_group = 'STATE OF UT - OSDC - 3P-2'	                            then    0
                    when    pl_group = 'STATE OF VA - DOT - 3P'	                                then    0
                    when    pl_group = 'STATE OF VA - DOT - 3P-2'	                            then    800
                    when    pl_group = 'SWEDISH HOSPITAL - 3P'	                                then    0
                    when    pl_group = 'TOWER HEALTH PHYS - 3P -2'	                            then    0
                    when    pl_group = 'TPC - SHANNON - HOSP - 3P-2'	                        then    0
                    when    pl_group = 'TPC - SHANNON - PHY - 3P-2'	                            then    100
                    when    pl_group = 'TPC - UNITED REGIONAL - 3P'	                            then    0
            ...
            0  as  max_cost_running_texts,
            case    when    pl_group = 'ADVOCATE HC - 3P'                                       then  0
                    when    pl_group = 'ASPEN DENTAL - 3P'                                      then  100
                    when    pl_group = 'BAYLOR SCOTT WHITE HEALTHCARE EPIC - 3P'                then  1000
                    when    pl_group = 'BAYLOR SCOTT WHITE HEALTHCARE EPIC - 3P-2'              then  700
                    when    pl_group = 'BROWARD HEALTH - 3P'                                    then  100
                    when    pl_group = 'CARLE HEALTHCARE - 3P'                                  then  300
                    when    pl_group = 'CARLE HEALTHCARE - 3P-2'                                then  100
                    when    pl_group = 'CHILDRENS HOSP OF ATLANTA - 3P'                         then  200
                    when    pl_group = 'CHOP - 3P'                                              then  200
                    when    pl_group = 'EVERGY - 3P'                                            then  0
                    ...
                    when    pl_group = 'IU SURGICAL CARE AFF - 3P'                              then  0
                    when    pl_group = 'LOYOLA UNIV HEALTH SYSTEM - 3P'                         then  200
                    when    pl_group = 'MCLEOD HEALTH - 3P'                                     then  400
                    when    pl_group = 'NORTHSHORE UNIV HEALTH - 3P'                            then  800
                    when    pl_group = 'NORTHWESTERN MEDICINE - 3P'                             then  1000
                    when    pl_group = 'NW COMM HOSP - 3P'                                      then  100
                    when    pl_group = 'NW COMM HOSP - 3P-2'                                    then  0
                    when    pl_group = 'PALOS HEALTH - 3P'                                      then  0
                    when    pl_group = 'PRISMA HEALTH - 3P'                                     then  1000
                    when    pl_group = 'PRISMA HEALTH - 3P-2'                                   then  1000
                    when    pl_group = 'PRISMA HEALTH UNIVERSITY - 3P'                          then  400
                    when    pl_group = 'PROMEDICA HS - 3P-2'                                    then  600
                    when    pl_group = 'PROVIDENCE ST JOSEPH HEALTH - 3P'                       then  2000
                    when    pl_group = 'SHIRLEY RYAN ABILITY LABS - 3P'                         then  0
                    when    pl_group = 'SILVER CROSS - 3P'                                      then  0
                    when    pl_group = 'SILVER CROSS - HEALTH SYSTEM SERVICES INC - 3P'         then  0
                    when    pl_group = 'ST ELIZABETH HEALTHCARE - 3P'                           then  100
                    when    pl_group = 'STATE OF IL - DOR - 3P'                                 then  200
                    when    pl_group = 'STATE OF IL - DOR - 3P-2'                               then  0
                    when    pl_group = 'STATE OF KS - DOR - 3P'                                 then  1400
                    when    pl_group = 'STATE OF OK - TAX COMMISSION - 3P'                      then  1000
                    when    pl_group = 'STATE OF VA - DOT - 3P'                                 then  300
                    when    pl_group = 'STATE OF VA - DOT - 3P-2'                               then  2000
                    when    pl_group = 'SWEDISH HOSPITAL - 3P'                                  then  0
                    when    pl_group = 'TOWER HEALTH HOSP - 3P -2'                              then  0
                    when    pl_group = 'TOWER HEALTH PHYS - 3P -2'                              then  0
                    when    pl_group = 'TPC - SHANNON - HOSP - 3P-2'                            then  100
                    when    pl_group = 'TPC - SHANNON - PHY - 3P-2'                             then  500
                    when    pl_group = 'TPC - UNITED REGIONAL - 3P'                             then  0
                    when    pl_group = 'U OF CHICAGO MEDICAL - 3P'                              then  300
                    when    pl_group = 'U OF CINCINNATI HEALTH SYSTEM - 3P'                     then  100
                    when    pl_group = 'U OF IL AT CHICAGO - 3P'                                then  100
                    when    pl_group = 'UNITED REGIONAL - 3P-2'                                 then  0
                    when    pl_group = 'UNIVERSAL HEALTH SERVICES - 3P'                         then  700
                    else    0
